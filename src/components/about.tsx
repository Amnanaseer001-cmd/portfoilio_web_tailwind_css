      ...
      <div className="flex justify-between bg-[#1b1b1b]">
        ...
        <div className="mt-48 mr-16">
          ...
          <p className="mt-4 leading-8 text-[16px] text-gray-300">
            I&apos;m Amna Naseer, a web developer skilled in HTML, CSS,
            JavaScript <br /> and TypeScript.I'm currently expanding my
            expertise by learning Next.js <br /> and building dynamic project
            Pursuing a Bachelor in Computer Science <br /> I have hands-on
            experience with C++ for software development. <br /> I enjoy
            creating engaging web experiences and am passionate about <br />
